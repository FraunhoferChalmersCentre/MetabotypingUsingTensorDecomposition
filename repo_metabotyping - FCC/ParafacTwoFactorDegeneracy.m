function [Factors,it,err,corcondia, factor_degeneracy]=ParafacTwoFactorDegeneracy(X,Fac,Options,const,OldLoad,FixMode,Weights);
factor_degeneracy = 0;
% I have just modified the original parafac.m to output if two-factor
% degenaracy occured. I have cited the N-way toolbox in the paper.
