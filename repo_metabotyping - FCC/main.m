...
%% Permute data
data_subtracted = permute(data_subtracted,[2 3 4 1]);  
...
classification_list_with_amino_acids = classification_list;
classification_list_with_amino_acids(indeces(amino_acids)) = 3;
class_list_cat = [classification_list_with_amino_acids', classification_list_with_amino_acids', classification_list_with_amino_acids'];
